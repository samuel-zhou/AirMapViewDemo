...
public class MainActivity extends AppCompatActivity
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    mapViewBuilder = new DefaultAirMapViewBuilder(this,false);
...
//    map.initialize(getSupportFragmentManager());
    AirMapInterface airMapInterface = new WebAirMapViewBuilder().withOptions(new GoogleChinaMapType()).build();
...
//          builder.include(new LatLng(37.771883, -122.405224));
//          builder.include(new LatLng(37.773975, -122.40205));
//          builder.include(new LatLng(37.772127, -122.404411));
//          builder.include(new LatLng(37.77572, -122.41354));
//          map.setBounds(builder.build(),10);
          break;
...
//    addMarker("Mapbox", new LatLng(37.77572, -122.41354), 4);
    map.animateCenterZoom(airbnbLatLng, 11);
...
//    map.getHandler().postDelayed(new Runnable() {
//      @Override
//      public void run() {
//        LatLngBounds.Builder builder = new LatLngBounds.Builder();
//        builder.include(new LatLng(37.771883, -122.405224));
